...
class TIMER_TYPES():
    ...
    OVERDRIVE_DELAY = {"TYPE":"overdrive_delay", "NEEDS_FUNCTION": True, "FUNCTION":SHEPHERD_HEADER.TRIGGER_OVERDRIVE}
    STUDENT_DECODE = {"TYPE":"student_decode", "NEEDS_FUNCTION": True, "FUNCTION":SHEPHERD_HEADER.CODE_RETRIEVAL}
